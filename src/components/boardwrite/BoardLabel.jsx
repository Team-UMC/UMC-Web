...
const BoardLabel = () => {
  ...
  return (
    ...
    <ContainerType>
      ...
      {buttonStates.schoolButton && <SchoolBoard />} {/* Conditionally render SchoolBoard */}
      {buttonStates.campButton && <CampBoard />} {/* Conditionally render SchoolBoard */}
      {buttonStates.unionButton && <UnionBoard />} {/* Conditionally render SchoolBoard */}
